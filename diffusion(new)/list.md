...
- [x] **风格的定义与量化**：探讨什么是风格，如何数学化地表示和量化风格特征。

- [x]  **内容的提取与表示**：深度神经网络在内容特征提取中的作用。

- [x] **风格与内容的交互关系**：分析二者在模型中的融合方式。
...
- [x] **基于统计的方法**：如Gram矩阵、特征协方差的应用。

- [x] **基于优化的方法**：通过损失函数设计实现风格与内容的平衡。


### 2.3 生成模型概述（Overview of Generative Models）

- [x] **GAN、VAE、扩散模型的比较**：核心思想、结构差异、适用场景。
